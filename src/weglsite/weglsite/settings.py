"""
Django settings for weglsite project.
...
SECRET_KEY = 'django-insecure-a8qv7#vh#&vaq8pyh2&r4gaqw7nls0e^91wpt5^v0eo*_ni+q3'
...
TEMPLATES = [
    {
        ...
        # tells Django to look in the 'templates' directory at the project level for templates as well
